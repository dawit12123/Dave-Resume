         ...
         <div class="container">
            <div class="row">
                  ...
                  <div class="mx-auto col-lg-5 col-md-5 col-10">
                      <img src="./assetsimages/profile_img.png"  class="img-fluid mt-3" alt="Dave image">
                  </div>

                   <div class="d-flex flex-column justify-content-center align-items-center col-lg-7 col-md-7 col-12">
                        <div class="hero-text">

                            <h1 class="hero-title">👋 Deve, a digital visioner</h1>

                            <a href="#" class="email-link">
                                dawitgirma71@gmail.com
                            </a>
        ...
        <div class="container">
            <div class="row ">
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <h3 class="mb-4">This is Dave Resume</h3>
                    ...
                    <ul class="mt-4 mb-5 mb-lg-0 profile-list list-unstyled">
                        <li><strong>Full Name :</strong> Dawit Girma Gina </li>

                        <li><strong>Date of Birth:</strong> 29 Augest 1996</li>
                        <li><strong>Address:</strong> Addis Ababa, Ethiopia</li>
                        <li><strong>Phone</strong> +251936676745</li>

                        <!-- <li><strong>Website :</strong> company.co</li> -->

                        <li><strong>Email :</strong> dawitgirma71@gmail.com</li>
                    </ul>
                </div>

                <div class="col-lg-5 mx-auto col-md-6 col-12">
                    <img src="./assetsimages/true-agency.jpg" class="about-image img-fluid" alt="Deve Resume">
                </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="owl-carousel owl-theme" id="testimonials-carousel">
                            <div class="item">
                                <div class="testimonials-thumb d-flex">
                                    <div class="testimonials-image">
                                        <img src="./assetsimages/testimonials/testimonial-image01.jpg" class="img-fluid" alt="testimonials image">
                                    </div>
                            ...
                            <div class="item">
                                <div class="testimonials-thumb d-flex">
                                    <div class="testimonials-image">
                                        <img src="./assetsimages/testimonials/testimonial-image02.jpg" class="img-fluid" alt="testimonials image">
                                    </div>
                            ...
                            <div class="item">
                                <div class="testimonials-thumb d-flex">
                                    <div class="testimonials-image">
                                        <img src="./assetsimages/testimonials/testimonial-image03.jpg" class="img-fluid" alt="testimonials image">
                                    </div>
                            ...
                            <div class="item">
                                <div class="testimonials-thumb d-flex">
                                    <div class="testimonials-image">
                                        <img src="./assetsimages/testimonials/testimonial-image04.jpg" class="img-fluid" alt="testimonials image">
                                    </div>

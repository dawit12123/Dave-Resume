         ...
         <div class="container">
            <div class="row">
                  ...
                  <div class="mx-auto col-lg-5 col-md-5 col-10">
                      <img src="../../assets/images/profile_img.png"  class="img-fluid mt-3" alt="Dave image">
                  </div>
        ...
        <div class="container">
            <div class="row ">
                ...
                <div class="col-lg-5 mx-auto col-md-6 col-12">
                    <img src="../../assets/images/true-agency.jpg" class="about-image img-fluid" alt="Deve Resume">
                </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="owl-carousel owl-theme" id="testimonials-carousel">
                            <div class="item">
                                <div class="testimonials-thumb d-flex">
                                    <div class="testimonials-image">
                                        <img src="../../assets/images/testimonials/testimonial-image01.jpg" class="img-fluid" alt="testimonials image">
                                    </div>
                            ...
                            <div class="item">
                                <div class="testimonials-thumb d-flex">
                                    <div class="testimonials-image">
                                        <img src="../../assets/images/testimonials/testimonial-image02.jpg" class="img-fluid" alt="testimonials image">
                                    </div>
